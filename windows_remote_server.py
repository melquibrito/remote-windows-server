...
class WindowsRemoteServer:
    ...
    def manage_services(self)->'WindowsRemoteServer.__ServiceManager':
    ...
    def manage_processes(self)->'WindowsRemoteServer.__ProcessManager':
    ...
    class __ServiceManager:
        ...
        def get(self, name:str)->'WindowsRemoteServer.__ServiceManager.__Service':
            ...
            Returns
            -------
            - WindowsRemoteServer.__ServiceManager.__Service: Service instance object.
        ...
        class __Service:
            ...
            def __init__(self, server:'WindowsRemoteServer', name:str):
                self.__name = name
                self.__server = server
                pass
